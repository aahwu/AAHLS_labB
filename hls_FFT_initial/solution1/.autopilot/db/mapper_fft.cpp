...
extern "C" void fft(int*, int*);
extern "C" void apatb_fft_hw(volatile void * __xlx_apatb_param_X_R, volatile void * __xlx_apatb_param_X_I) {
  ...
  // DUT call
  fft(__xlx_X_R__input_buffer, __xlx_X_I__input_buffer);
