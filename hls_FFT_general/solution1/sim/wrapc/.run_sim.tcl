...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fft_stages.autotvin.dat"
	set constFileTvOut       "fft_stages.autotvout.dat"
	set constFileHdlTvIn     "fft_stages.autohdltvin.dat"
	set constFileHdlTvOut    "fft_stages.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
