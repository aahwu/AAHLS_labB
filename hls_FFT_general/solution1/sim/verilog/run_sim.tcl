...
if {[file isfile fft_stages.autotvin.dat]} {
	file delete -force fft_stages.autotvin.dat
}

if {[file isfile fft_stages.autotvout.dat]} {
	file delete -force fft_stages.autotvout.dat
}
