...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fft.autotvin_X_R_0.dat"
         "c.fft.autotvin_X_R_1.dat"
         "c.fft.autotvin_X_R_2.dat"
         "c.fft.autotvin_X_R_3.dat"
         "c.fft.autotvin_X_I_0.dat"
         "c.fft.autotvin_X_I_1.dat"
         "c.fft.autotvin_X_I_2.dat"
         "c.fft.autotvin_X_I_3.dat"
         "c.fft.autotvin_OUT_R_0.dat"
         "c.fft.autotvin_OUT_R_1.dat"
         "c.fft.autotvin_OUT_R_2.dat"
         "c.fft.autotvin_OUT_R_3.dat"
         "c.fft.autotvin_OUT_I_0.dat"
         "c.fft.autotvin_OUT_I_1.dat"
         "c.fft.autotvin_OUT_I_2.dat"
         "c.fft.autotvin_OUT_I_3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fft.autotvout_OUT_R_0.dat"
         "rtl.fft.autotvout_OUT_R_1.dat"
         "rtl.fft.autotvout_OUT_R_2.dat"
         "rtl.fft.autotvout_OUT_R_3.dat"
         "rtl.fft.autotvout_OUT_I_0.dat"
         "rtl.fft.autotvout_OUT_I_1.dat"
         "rtl.fft.autotvout_OUT_I_2.dat"
         "rtl.fft.autotvout_OUT_I_3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
