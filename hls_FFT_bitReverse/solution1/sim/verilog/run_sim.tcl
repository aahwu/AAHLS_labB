...
if {[file isfile bit_reverse.autotvin.dat]} {
	file delete -force bit_reverse.autotvin.dat
}

if {[file isfile bit_reverse.autotvout.dat]} {
	file delete -force bit_reverse.autotvout.dat
}
