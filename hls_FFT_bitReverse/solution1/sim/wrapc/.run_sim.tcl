...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bit_reverse.autotvin.dat"
	set constFileTvOut       "bit_reverse.autotvout.dat"
	set constFileHdlTvIn     "bit_reverse.autohdltvin.dat"
	set constFileHdlTvOut    "bit_reverse.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
