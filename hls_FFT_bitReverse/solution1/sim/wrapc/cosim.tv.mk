...
$(ObjDir)/bit_reverse_test.cpp_pre.cpp.tb.o : bit_reverse_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bit_reverse_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/bit_reverse.cpp_pre.cpp.tb.o : bit_reverse.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling bit_reverse.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
